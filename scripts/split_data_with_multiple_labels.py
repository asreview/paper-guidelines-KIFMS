...
>>> python split_data_with_multiple_labels.py ptsd.csv output --split label_included label_abstract_screening label3 --suffix final tiab label3

1 label column (renames the label only):

>>> python split_data_with_multiple_labels.py ptsd.csv output --split label_included --suffix final
